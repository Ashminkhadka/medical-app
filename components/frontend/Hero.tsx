...
const Hero = () => {
  ...
  return (
    <div className="bg-blue-950 ">
      <div className="relative pb-[110px] pt-[120px] dark:bg-dark 
      lg:pt-[50px] max-w-7xl mx-auto">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-6/12">
              <div className="hero-content">             
                ...
                to bring you simple, affordable, and transparent
                healthcare.
                </p>
                {/* SEARCH BAR */}
                <SearchBar/>
                ...
                <ul className="flex flex-wrap items-center mt-6">
                  ...
                  <li>
                    ...
                    >
                      <span className="mr-2">
                        <Pill className="flex-shrink-o h-4 w-4
                        text-blue-600"/>
                      </span>
                      Need a Refill
                    </a>
                ...
                <div className="py-4 pt-8 flex gap-4">
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <span className="font-bold text-gray-50">1900</span>
