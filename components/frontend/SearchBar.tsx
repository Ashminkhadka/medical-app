...
<form className="max-w-md mx">   
    ...
    <div className="relative">
        ...
        flex items-center ps-3 pointer-events-none">
            <MagnifyingGlassIcon className="w-6 h-4 text-dark
            dark:text-gray-700"/>
        </div>
        <input type="search" id="default-search" 
        className="block w-full p-4 ps-10 text-sm text-gray-900 
        border border-gray-50 rounded-full bg-gray-50 
        focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-200 
        dark:border-gray-600 dark:placeholder-gray-700 dark:text-white-100 
